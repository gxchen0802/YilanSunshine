...
;function scrollFixed(t){var o=$(t),e=document.body,n=!0,a=o.height(),l=o.offset().top;$(window).on("scroll",throttle(function(){var t=e.scrollTop||document.documentElement.scrollTop;t>l+a+5?n&&(o.css({top:-(a+40)+"px"}),o.addClass("fixed"),o.animate({top:0}),n=!1):(n=!0,o.removeClass("fixed").css({top:"45px"}))},100,1e3/60))}function throttle(t,o,e){var n,a=null;return function(){var l=this,s=arguments,i=+new Date;clearTimeout(a),n||(n=i),i-n>=e?(t.apply(l,s),n=i):a=setTimeout(function(){t.apply(l,s)},o)}}$(function(){scrollFixed(".nav"),$(".nav").on("click",".item",function(t){var o=$(this).attr("href");$(this).addClass("active").siblings().removeClass("active"),$("html,body").animate({scrollTop:$(o).offset().top-70},500),t.preventDefault(),t.stopPropagation()})});